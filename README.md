...
running command...
$ pspm (--version)
pspm/0.0.0 win32-x64 node-v18.16.0
$ pspm --help [COMMAND]
USAGE
  $ pspm COMMAND
...
...
Export a set of Profiles, Printers, and Materials
...
_See code: [dist/commands/export/index.ts](https://github.com/ATechAdventurer/pspm/blob/v0.0.0/dist/commands/export/index.ts)_
...
<!-- commandsstop -->
* [`pspm hello PERSON`](#pspm-hello-person)
* [`pspm hello world`](#pspm-hello-world)
* [`pspm help [COMMANDS]`](#pspm-help-commands)
* [`pspm install URL`](#pspm-install-url)
* [`pspm plugins`](#pspm-plugins)
* [`pspm plugins:install PLUGIN...`](#pspm-pluginsinstall-plugin)
* [`pspm plugins:inspect PLUGIN...`](#pspm-pluginsinspect-plugin)
* [`pspm plugins:install PLUGIN...`](#pspm-pluginsinstall-plugin-1)
...
_See code: [dist/commands/hello/index.ts](https://github.com/ATechAdventurer/pspm/blob/v0.0.0/dist/commands/hello/index.ts)_
...
_See code: [dist/commands/hello/world.ts](https://github.com/ATechAdventurer/pspm/blob/v0.0.0/dist/commands/hello/world.ts)_
